...
def build_open_ai_embeddings_request(deployment_id: str, *, model: Optional[str] = None, **kwargs: Any) -> HttpRequest:
...
class OpenAIClientOperationsMixin(OpenAIClientMixinABC):
    ...
    def embeddings(
        self,
        deployment_id: str,
        body: _models.EmbeddingsRequest,
        *,
        ...
        **kwargs: Any
        ...
        :param body: Required.
        :type body: ~azure.openai.models.EmbeddingsRequest
    ...
    def embeddings(
        self,
        deployment_id: str,
        body: Union[_models.EmbeddingsRequest, JSON, IO],
        *,
        model: Optional[str] = None,
        **kwargs: Any
    ) -> _models.Embeddings:
        ...
        :type body: ~azure.openai.models.EmbeddingsRequest or JSON or IO
        :keyword model: ID of the model to use. Default value is None.
        :paramtype model: str
