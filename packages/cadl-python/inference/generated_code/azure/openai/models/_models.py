...
class CompletionsPrompt1(_model_base.Model):
    """CompletionsPrompt1.

    All required parameters must be populated in order to send to Azure.

    :ivar name1: name1. Required.
    :vartype name1: str
    """

    name1: str = rest_field()
    """name1. Required. """
...
class CompletionsPrompt2(_model_base.Model):
    """CompletionsPrompt2.

    All required parameters must be populated in order to send to Azure.

    :ivar name2: name2. Required.
    :vartype name2: str
    """

    name2: str = rest_field()
    """name2. Required. """
...
class CompletionsPrompt3(_model_base.Model):
    """CompletionsPrompt3.

    All required parameters must be populated in order to send to Azure.

    :ivar name3: name3. Required.
    :vartype name3: str
    """

    name3: str = rest_field()
    """name3. Required. """
...
class CompletionsRequest(_model_base.Model):
    """CompletionsRequest.

    :ivar prompt: CompletionsRequest. Is one of the following types: model, model, model
    :vartype prompt: ~azure.openai.models.CompletionsPrompt1 or
     ~azure.openai.models.CompletionsPrompt2 or ~azure.openai.models.CompletionsPrompt3
    """

    prompt: Optional[
        Union[CompletionsPrompt1, CompletionsPrompt2, CompletionsPrompt3]
    ] = rest_field()
    """CompletionsRequest. Is one of the following types: model, model, model"""
