...
from ._operations import AuthoringClientOperationsMixin, InferenceClientOperationsMixin
...
class InferenceClient(InferenceClientOperationsMixin):  # pylint: disable=client-accepts-api-version-keyword
    """InferenceClient.
